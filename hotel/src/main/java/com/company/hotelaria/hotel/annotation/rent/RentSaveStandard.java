...
@ApiResponses(value = {
        @ApiResponse(responseCode = "201", description = "Hospedagem criada",
...
@Operation(summary = ConstantsUnit.RENT_SAVE_SUMMARY, description = ConstantsUnit.RENT_SAVE_DESCRIPTION)
public @interface RentSaveStandard {
}
