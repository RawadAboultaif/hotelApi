...
public class ConstantsPayment {
    ...
    public static final String PAYMENT_DELETE_DESCRIPTION="Irá deletar um cartão na api";
    public static final String PAYMENT_UPDATE_SUMARY="Atualizar um cartão";
    public static final String PAYMENT_UPDATE_DESCRIPTION="Irá atualizar um cartão na api";
}
